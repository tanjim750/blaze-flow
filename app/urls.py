...
from .views import (
    ...
    task_detail,
    task_stage_detail,
    task_stage_list_create,
    task_workflow_settings,
    task_list_create,
    workspace_detail,
...
urlpatterns = [
    ...
    path('workspaces/<uuid:workspace_id>/task-stages/', task_stage_list_create, name='api-task-stages'),
    path('workspaces/<uuid:workspace_id>/task-stages/settings/', task_workflow_settings, name='api-task-stage-settings'),
    ...
    path('workspaces/<uuid:workspace_id>/projects/<uuid:project_id>/files/<uuid:file_id>/download/', project_file_download, name='api-project-file-download'),
    ...
    path('workspaces/<uuid:workspace_id>/projects/<uuid:project_id>/media-versions/<uuid:media_version_id>/render/', media_version_render_control, name='api-media-version-render-control'),
