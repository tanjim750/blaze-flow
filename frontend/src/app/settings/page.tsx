...
export default async function SettingsPage() {
  ...
  if (!session.user) {
    return <AppShell user={null}><div className="settings-page">
  ...
  return <AppShell user={toShellUser(user)} workspaces={workspaceContext.ok ? workspaceContext.data.workspaces : []} selectedWorkspaceId={workspace?.id}><div className="settings-page">
